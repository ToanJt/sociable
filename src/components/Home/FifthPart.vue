...
const message = ref("The results achieved by this agency were impressive. Their fitness-focused content resonated with our audience, fostering engagement and brand loyalty beyond our expectations.");
const messages = [
...
<template>
    <main class="space_small-components">
    ...
    x: 0
            ...
            <div class="background_img">
                ...
                <img src="@/assets/logo-brand/instagram.png" alt="" class="accessory_icon i40 icon2">
                <img src="@/assets/logo-brand/facebook.png" alt="" class="accessory_icon i50 icon3">
                <img src="@/assets/logo-brand/youtube.png" alt="" class="accessory_icon i40 icon4">
                <img src="@/assets/smile.png" alt="" class="accessory_icon i40 icon5">
                <img src="@/assets/fifth-part/decoration-02.png" alt="" class="accessory_icon i80 icon6">
            </div>
            <div v-motion :initial="{
                opacity: 0,
                x: 200
    ...
    x: 0
                ...
                <div class="rates">
                    <div class="images">
                        <img class="image i70 border_light" src="@/assets/fifth-part/review-01.jpg" alt="">
...
.border_light {
    ...
    box-shadow: rgba(89, 86, 233, 0.25) 0px 46px 47px, rgb(89, 86, 233, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;
    z-index: 5;
}
